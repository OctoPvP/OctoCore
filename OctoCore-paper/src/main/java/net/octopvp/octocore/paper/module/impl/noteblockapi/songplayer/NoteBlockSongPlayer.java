...
import net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils;
...
public class NoteBlockSongPlayer extends RangeSongPlayer {
    ...
    public NoteBlockSongPlayer(Song song) {
        super(song);
        makeNewClone(net.octopvp.octocore.paper.module.impl.noteblockapi.NoteBlockSongPlayer.class);
    }
