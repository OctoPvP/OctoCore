...
/**
 * @deprecated {@link net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils}
 */
@Deprecated
public class CompatibilityUtils {
    ...
    public static Class<?> getMinecraftClass(String name) {
        return net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.getMinecraftClass(name);
    }
    ...
    public static Class<?> getCraftBukkitClass(String name) {
        return net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.getCraftBukkitClass(name);
    }
    ...
    public static boolean isPost1_12() {
        return net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.isPost1_12();
    }
    ...
    protected static boolean isSoundCategoryCompatible() {
        return net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.getServerVersion() >= 0.0111f;
    }
    ...
    public static void playSound(Player player, Location location, String sound,
        ...
        net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.playSound(player, location, sound, net.octopvp.octocore.paper.module.impl.noteblockapi.model.SoundCategory.valueOf(category.name()), volume, pitch);
    }
    ...
    public static ArrayList<CustomInstrument> getVersionCustomInstrumentsForSong(int firstCustomInstrumentIndex) {
        ...
        if (net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.getServerVersion() < 0.0112f) {
        ...
        } else if (net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.getServerVersion() < 0.0114f) {
