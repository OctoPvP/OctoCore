...
public class PunishmentRedisHandler {
    @RedisHandler(jedisAction = JedisAction.EXECUTE_PUNISHMENT)
    public static void onExecPunishment(JsonObject data) {
       try {
           Logger.debug("Punishment exec: " + OctoCore.getGson().toJson(data));
