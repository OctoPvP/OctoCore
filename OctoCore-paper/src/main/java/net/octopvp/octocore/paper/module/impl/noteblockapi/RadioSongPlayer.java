...
/**
 * @deprecated {@link net.octopvp.octocore.paper.module.impl.noteblockapi.songplayer.RadioSongPlayer}
 */
@Deprecated
public class RadioSongPlayer extends SongPlayer {
    ...
    public RadioSongPlayer(Song song) {
        super(song);
        makeNewClone(net.octopvp.octocore.paper.module.impl.noteblockapi.songplayer.RadioSongPlayer.class);
    }
    ...
    public RadioSongPlayer(net.octopvp.octocore.paper.module.impl.noteblockapi.songplayer.SongPlayer songPlayer) {
        super(songPlayer);
    }
