 ...
 * @deprecated {@link net.octopvp.octocore.paper.module.impl.noteblockapi.utils.Interpolator}
 */
@Deprecated
public class Interpolator {

    public static double[] interpLinear(double[] x, double[] y, double[] xi) throws IllegalArgumentException {
        return net.octopvp.octocore.paper.module.impl.noteblockapi.utils.Interpolator.interpLinear(x, y, xi);
    }
    ...
    public static double interpLinear(double[] xy, double xx) {
        return net.octopvp.octocore.paper.module.impl.noteblockapi.utils.Interpolator.interpLinear(xy, xx);
    }
