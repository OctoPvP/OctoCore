...
public class EnchantCommand {
    ...
    public CommandResult execute(Sender sender, Enchantment enchantment, @Optional @DefaultNumber(1) @Range(min = -Integer.MIN_VALUE, max = Integer.MAX_VALUE) int enchLevel) {
