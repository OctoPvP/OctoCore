package net.octopvp.octocore.paper.utils.tab.implementation;
...
import net.octopvp.octocore.paper.utils.tab.TabAdapter;
import net.octopvp.octocore.paper.utils.tab.client.ClientVersionUtil;
import net.octopvp.octocore.paper.utils.tab.skin.SkinType;
...
public class v1_8_R3TabAdapter extends TabAdapter {
    public static final v1_8_R3TabAdapter INSTANCE = new v1_8_R3TabAdapter();
    ...
    public TabAdapter sendHeaderFooter(Player player, String header, String footer) {
        if (this.getMaxElements(player) > 60 && (header != null || footer != null)) {
            final Packet<?> packet = new PacketPlayOutPlayerListHeaderFooter(IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + header + "\"}"));
