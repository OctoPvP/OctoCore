...
import net.octopvp.octocore.paper.module.impl.noteblockapi.event.*;
...
public abstract class SongPlayer {
    ...
    net.octopvp.octocore.paper.module.impl.noteblockapi.SongPlayer oldSongPlayer;
     ...
     * @deprecated
     */
    SongPlayer(net.octopvp.octocore.paper.module.impl.noteblockapi.SongPlayer songPlayer) {
        oldSongPlayer = songPlayer;
        net.octopvp.octocore.paper.module.impl.noteblockapi.Song s = songPlayer.getSong();
        HashMap<Integer, Layer> layerHashMap = new HashMap<Integer, Layer>();
        for (Integer i : s.getLayerHashMap().keySet()) {
            net.octopvp.octocore.paper.module.impl.noteblockapi.Layer l = s.getLayerHashMap().get(i);
            HashMap<Integer, Note> noteHashMap = new HashMap<Integer, Note>();
            for (Integer iL : l.getHashMap().keySet()) {
                net.octopvp.octocore.paper.module.impl.noteblockapi.Note note = l.getHashMap().get(iL);
        ...
        for (int i = 0; i < s.getCustomInstruments().length; i++) {
            net.octopvp.octocore.paper.module.impl.noteblockapi.CustomInstrument ci = s.getCustomInstruments()[i];
    ...
    void CallUpdate(String key, Object value) {
        ...
        try {
            Method m = net.octopvp.octocore.paper.module.impl.noteblockapi.SongPlayer.class.getDeclaredMethod("update", String.class, Object.class);
