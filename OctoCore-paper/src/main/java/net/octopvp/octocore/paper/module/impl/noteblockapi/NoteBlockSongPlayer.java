...
/**
 * @deprecated {@link net.octopvp.octocore.paper.module.impl.noteblockapi.songplayer.NoteBlockSongPlayer}
 */
@Deprecated
public class NoteBlockSongPlayer extends SongPlayer {
    ...
    public NoteBlockSongPlayer(Song song) {
        super(song);
        makeNewClone(net.octopvp.octocore.paper.module.impl.noteblockapi.songplayer.NoteBlockSongPlayer.class);
    }
    ...
    public NoteBlockSongPlayer(net.octopvp.octocore.paper.module.impl.noteblockapi.songplayer.SongPlayer songPlayer) {
        super(songPlayer);
    }
    ...
    public void playTick(Player player, int tick) {
        if (noteBlock.getType() != net.octopvp.octocore.paper.module.impl.noteblockapi.utils.CompatibilityUtils.getNoteBlockMaterial()) {
            return;
        }
