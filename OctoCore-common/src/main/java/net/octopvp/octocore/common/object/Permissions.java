...
public class Permissions {
    ...
    STAFFCHAT = "octocore.staff.chat", ADMINCHAT = "octocore.admin.chat", ADMIN_ALERT = "octocore.admin.alert", STAFF_ALERT = "octocore.staff.alert",

    RECEIVE_AUDIT_WORLDEDIT = "octocore.staff.audit.worldedit", RECEIVE_AUDIT_AUTH_FAIL = "octocore.staff.audit.authfail",

    BYPASS_SPAM_PROT = "octocore.bypass.spam",

    ENCHANT = "octocore.command.enchant", GIVE = "octocore.command.give",
    ...
    GRANT = "octocore.command.grant", GRANT_ALL = "octocore.grant.all",

    CREATE_RANK = "octocore.command.createrank", DELETE_RANK = "octocore.command.deleterank", EDIT_RANK = "octocore.command.editrank",


    PUNISHMENT_BASE = "octocore.punish.", PUNISHMENT_BASE_COMMAND = "octocore.punish.command.", PUNISHMENT_SEE_SILENT = PUNISHMENT_BASE + "see.silent", PUNISHMENT_UNBLACKLIST = PUNISHMENT_BASE + "unblacklist", PUNISHMENT_UNBAN = PUNISHMENT_BASE + "unblacklist", PUNISHMENT_UNMUTE = PUNISHMENT_BASE + "unblacklist", PUNISHMENT_STAFFROLLBACK = PUNISHMENT_BASE_COMMAND + "staffrollback", PUNISHMENT_STAFF_HISTORY = PUNISHMENT_BASE_COMMAND + "staffhistory", PUNISHMENT_HISTORY = PUNISHMENT_BASE_COMMAND + "history",

    PUNISHMENT_KICK = PUNISHMENT_BASE_COMMAND + "kick", PUNISHMENT_BAN = PUNISHMENT_BASE_COMMAND + "ban", PUNISHMENT_IPBAN = PUNISHMENT_BASE_COMMAND + "ipban", PUNISHMENT_BLACKLIST = PUNISHMENT_BASE_COMMAND + "blacklist", PUNISHMENT_WARN = PUNISHMENT_BASE_COMMAND + "warn", PUNISHMENT_MUTE = PUNISHMENT_BASE_COMMAND + "mute", PUNISHMENT_SEE_JOIN_ALERT = PUNISHMENT_BASE + "joinalert",

    TAG_ADMIN_MENU = "octocore.command.tagadmin",

    IGNORE_BYPASS = "octocore.ignore.bypass", SOCIAL_SPY = "octocore.socialspy",
