...
import net.octopvp.octocore.core.module.impl.noteblockapi.model.playmode.MonoStereoMode;
...
public class RadioSongPlayer extends SongPlayer {
    ...
    public RadioSongPlayer(Song song) {
        super(song);
        makeNewClone(net.octopvp.octocore.core.module.impl.noteblockapi.RadioSongPlayer.class);
    }
    ...
    private RadioSongPlayer(net.octopvp.octocore.core.module.impl.noteblockapi.SongPlayer songPlayer) {
        super(songPlayer);
    }
