package net.octopvp.octocore.core.utils.menu.menu;
...
import net.octopvp.octocore.core.utils.menu.buttons.impl.NextPageButton;
import net.octopvp.octocore.core.utils.menu.buttons.impl.PreviousPageButton;
