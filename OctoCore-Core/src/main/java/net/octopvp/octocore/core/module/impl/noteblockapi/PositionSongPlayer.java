...
/**
 * @deprecated {@link net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.PositionSongPlayer}
 */
@Deprecated
public class PositionSongPlayer extends SongPlayer {
    ...
    public PositionSongPlayer(Song song) {
        super(song);
        makeNewClone(net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.PositionSongPlayer.class);
    }
    ...
    public PositionSongPlayer(net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.SongPlayer songPlayer) {
        super(songPlayer);
    }
