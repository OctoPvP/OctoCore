...
import net.octopvp.octocore.core.module.impl.noteblockapi.event.*;
import net.octopvp.octocore.core.module.impl.noteblockapi.model.*;
import net.octopvp.octocore.core.module.impl.noteblockapi.model.playmode.ChannelMode;
import net.octopvp.octocore.core.module.impl.noteblockapi.model.playmode.MonoMode;
...
public abstract class SongPlayer {
    ...
    net.octopvp.octocore.core.module.impl.noteblockapi.SongPlayer oldSongPlayer;
     ...
     * @deprecated
     */
    SongPlayer(net.octopvp.octocore.core.module.impl.noteblockapi.SongPlayer songPlayer) {
        oldSongPlayer = songPlayer;
        net.octopvp.octocore.core.module.impl.noteblockapi.Song s = songPlayer.getSong();
        HashMap<Integer, Layer> layerHashMap = new HashMap<Integer, Layer>();
        for (Integer i : s.getLayerHashMap().keySet()) {
            net.octopvp.octocore.core.module.impl.noteblockapi.Layer l = s.getLayerHashMap().get(i);
            HashMap<Integer, Note> noteHashMap = new HashMap<Integer, Note>();
            for (Integer iL : l.getHashMap().keySet()) {
                net.octopvp.octocore.core.module.impl.noteblockapi.Note note = l.getHashMap().get(iL);
        ...
        for (int i = 0; i < s.getCustomInstruments().length; i++) {
            net.octopvp.octocore.core.module.impl.noteblockapi.CustomInstrument ci = s.getCustomInstruments()[i];
    ...
    void CallUpdate(String key, Object value) {
        ...
        try {
            Method m = net.octopvp.octocore.core.module.impl.noteblockapi.SongPlayer.class.getDeclaredMethod("update", String.class, Object.class);
    ...
    void makeNewClone(Class newClass) {
        try {
            ...
            oldSongPlayer = (net.octopvp.octocore.core.module.impl.noteblockapi.SongPlayer) c.newInstance(new Object[]{this});
