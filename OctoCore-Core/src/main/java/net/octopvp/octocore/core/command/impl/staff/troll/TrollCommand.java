package net.octopvp.octocore.core.command.impl.staff.troll;
...
import net.octopvp.octocore.core.utils.trolls.CrashClient;
...
public class TrollCommand {
    ...
    @PlayerOnly
    public CommandResult execute(@Sender Player sender, @Switch(value = "c", aliases = "crash") boolean crash) {
        if (crash) {
