...
public class ManageTagMenu extends Menu {
    ...
    public class BackButton extends net.octopvp.octocore.core.utils.menu.buttons.impl.BackButton {
        @Override
        public int getSlot() {
            return 22;
        }
    ...
    private class CloseButton extends net.octopvp.octocore.core.utils.menu.buttons.impl.CloseButton {
        @Override
        public int getSlot() {
            return 22;
        }
