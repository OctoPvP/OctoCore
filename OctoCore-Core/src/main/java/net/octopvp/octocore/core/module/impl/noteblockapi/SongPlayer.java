...
/**
 * @deprecated {@link net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.SongPlayer}
 */
@Deprecated
public abstract class SongPlayer {
    ...
    private net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.SongPlayer newSongPlayer;
    ...
    SongPlayer(net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.SongPlayer songPlayer) {
        newSongPlayer = songPlayer;
        song = createSongFromNew(songPlayer.getSong());
        plugin = NoteBlockPlayerMain.plugin;
    }

    private Song createSongFromNew(net.octopvp.octocore.core.module.impl.noteblockapi.model.Song s) {
        HashMap<Integer, Layer> layerHashMap = new HashMap<Integer, Layer>();
        for (Integer i : s.getLayerHashMap().keySet()) {
            net.octopvp.octocore.core.module.impl.noteblockapi.model.Layer l = s.getLayerHashMap().get(i);
            HashMap<Integer, Note> noteHashMap = new HashMap<Integer, Note>();
            for (Integer iL : l.getNotesAtTicks().keySet()) {
                net.octopvp.octocore.core.module.impl.noteblockapi.model.Note note = l.getNotesAtTicks().get(iL);
        ...
        for (int i = 0; i < s.getCustomInstruments().length; i++) {
            net.octopvp.octocore.core.module.impl.noteblockapi.model.CustomInstrument ci = s.getCustomInstruments()[i];
    ...
    void update(String key, Object value) {
        switch (key) {
            ...
            case "soundCategory":
                ...
                break;
            case "song":
                song = createSongFromNew((net.octopvp.octocore.core.module.impl.noteblockapi.model.Song) value);
                break;
    ...
    void CallUpdate(String key, Object value) {
        try {
            Method m = net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.SongPlayer.class.getDeclaredMethod("update", String.class, Object.class);
    ...
    void makeNewClone(Class newClass) {
        try {
            ...
            newSongPlayer = (net.octopvp.octocore.core.module.impl.noteblockapi.songplayer.SongPlayer) c.newInstance(new Object[]{this});
