...
public class SetupListeners implements Setup {
    private static final Listener[] listeners = new Listener[]{new PunishmentListener(), new JoinLeaveListener(), new ChatListener(), new DeathListener(), new CommandProcessEvent()};
