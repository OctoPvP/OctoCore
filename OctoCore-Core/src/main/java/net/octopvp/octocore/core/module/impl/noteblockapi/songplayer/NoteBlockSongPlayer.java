...
import net.octopvp.octocore.core.module.impl.noteblockapi.SongPlayer;
import net.octopvp.octocore.core.module.impl.noteblockapi.event.PlayerRangeStateChangeEvent;
import net.octopvp.octocore.core.module.impl.noteblockapi.model.*;
import net.octopvp.octocore.core.module.impl.noteblockapi.utils.CompatibilityUtils;
...
public class NoteBlockSongPlayer extends RangeSongPlayer {
    ...
    public NoteBlockSongPlayer(Song song) {
        super(song);
        makeNewClone(net.octopvp.octocore.core.module.impl.noteblockapi.NoteBlockSongPlayer.class);
    }
