package net.octopvp.aetheriacoremaster.master;
...
import net.octopvp.aetheriacore.common.ServerImplementation;
import net.octopvp.aetheriacore.common.manager.IServerManager;
import net.octopvp.aetheriacore.common.redis.RedisManager;
import net.octopvp.aetheriacore.common.redis.packets.VotePacket;
...
import net.octopvp.aetheriacoremaster.master.redis.RedisPackets;
import net.octopvp.aetheriacoremaster.master.util.AccountUtil;
...
import net.octopvp.aetheriacoremaster.repositories.VotesRepository;
...
@Getter
@Component
public class AetheriaCoreMaster {
    ...
    public AetheriaCoreMaster() {
        LOG.info("Starting Master...");
        AetheriaCoreCommon.getInstance().init(GSON, new ServerImplementation() {
            @Override
