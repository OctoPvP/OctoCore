...
import net.octopvp.aetheriacoremaster.core.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                //.antMatchers("/js/**").permitAll() // Login page does not require JS.
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader
                .getResource(spPrivateKeyFile);
        String storePass = spPrivateKeyPassword;
        Map<String, String> passwords = new HashMap<String, String>();
        passwords.put(spAlias, spPrivateKeyPassword);
        String defaultKey = spAlias;
    ...
    public ExtendedMetadataDelegate ssoCircleExtendedMetadataProvider()
        ...
        //String idpSSOCircleMetadataURL = "https://hub.aetheria.world/hub/api/rest/saml2/metadata";
